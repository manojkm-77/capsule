...
export function GenZHero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col justify-between overflow-hidden bg-dark px-6 pb-12 pt-24 text-stitch">
      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between mb-8">
      ...
      <div className="z-10 mx-auto my-auto w-full max-w-7xl">
        <h1 className="mb-6 text-6xl font-black uppercase leading-[0.88] tracking-tighter md:text-8xl lg:text-9xl">
          STITCHED <br />
