          ...
          {drops.map((drop, i) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col gap-4 rounded-3xl border border-white/5 bg-card/30 p-5 sm:p-8 transition-all hover:border-white/10 sm:flex-row sm:items-center sm:justify-between"
              >
