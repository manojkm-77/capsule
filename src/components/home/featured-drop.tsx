...
export function FeaturedDrop() {
  return (
    <section id="drops" className="relative overflow-hidden py-28">
          ...
          {drops.map((drop, i) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col gap-4 rounded-3xl border border-white/5 bg-card/30 p-8 transition-all hover:border-white/10 sm:flex-row sm:items-center sm:justify-between"
              >
                ...
                {drop.status === "live" && (
                  <Link
                    href="/shop"
                    className="flex items-center gap-2 self-start rounded-full bg-lime px-6 py-3 text-[0.7rem] font-bold uppercase tracking-wider text-dark transition-all hover:bg-lime/80 sm:self-center"
                  >
                    Shop Drop
                ...
                {drop.status === "upcoming" && (
                  <div className="flex items-center gap-2 self-start rounded-full border border-lime/20 px-6 py-3 text-[0.7rem] font-bold uppercase tracking-wider text-lime sm:self-center">
