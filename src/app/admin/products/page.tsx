...
const emptyForm = { name: "", category: "Fitted", price: 0, originalPrice: 0, stock: 0, color: "#0B0B0B", badge: "" };
...
export default function AdminProductsPage() {
  ...
  const openEdit = (p: Product) => {
    setEditing(p);
    setForm({ name: p.name, category: p.category, price: p.price, originalPrice: p.originalPrice || 0, stock: p.stock, color: p.color, badge: p.badge || "" });
    setShowForm(true);
  };
